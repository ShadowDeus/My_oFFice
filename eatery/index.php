                    ...
                    <div class="col-md-6 col-sm-12">
                         ...
                         <form  method="post" class="wow fadeInUp" id="contact-form" role="form" data-wow-delay="0.8s">
                              ...
                              <div class="col-md-12 col-sm-12">
                                   ...
                                   <textarea class="form-control" rows="6" id="cf-message" name="messages" placeholder="Tell about your project"></textarea>
` 
                                   <!-- <button type="submit" class="form-control" id="cf-submit" name="submit">Send Message</button> -->
                                   <input type="submit" class="form-control" id="cf-submit" name="submit" value="Send Message">
    ...
    if($submit) {
     ...
     $sql = "insert into cafe (name,email,subject,messages) values ('$name','$email','$subject','$messages')";
